...
const taskClassifierPrompt = [
  ...
  'list_advisor_proposals={"kind":"list_advisor_proposals"}; review_advisor_proposal={"kind":"review_advisor_proposal","proposalId":string,"decision":"approve_for_planning"|"reject"};',
  ...
  "Advisor approval permits planning only; it never applies, executes, deploys, edits configuration, or changes permissions. Never invent an advisor proposal id.",
