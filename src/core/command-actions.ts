...
export function parseSlashCommand(text: string): CommandAction | null {
  ...
  switch (command.toLowerCase()) {
    ...
    case "/projects": return { kind: "list_projects" }; case "/project": return { kind: "select_project", selector: argument }; case "/cd": return argument ? { kind: "select_project", selector: argument, explicitPath: true } : null;
