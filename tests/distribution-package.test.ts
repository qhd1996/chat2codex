...
async function fixture(): Promise<string> {
  ...
  await writeFile(path.join(root, "distribution", "release-manifest.json"), JSON.stringify({ schemaVersion: 1, packageVersion: "0.8.0-test.1", windows: { supported: ["win32-x64"], unverified: ["win32-arm64"] }, node: ">=20.12.0", codexCli: "0.146.0", desktop: "Task 12 required", stateSchemas: { read: [4,5,6], write: 6 }, hooks: hashes, requiredDocs: ["docs/windows/lifecycle.md","docs/windows/compatibility.md","docs/windows/troubleshooting.md","docs/quality/clean-windows-e2e-runbook.md"] }));
  return root;
}
