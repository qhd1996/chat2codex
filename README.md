...
Phase 1 includes inbound images and text-only Weixin replies. The bounded,
redacted, review-only UsageAdvisor foundation is implemented. Outbound Weixin
media, Codex desktop live status/same-thread handoff, and controlled groups keep
